...
// ============================================================
// OLD GOOGLE GEMINI CODE (commented out - now using NVIDIA)
// ============================================================
...
// ============================================================
// NVIDIA API Config (Active) — model: meta/llama-3.1-8b-instruct
// ============================================================
const getAIConfig = () => ({
...
// ============================================================
// OLD GOOGLE GEMINI generateGeminiText (commented out)
// ============================================================
...
export const generateAIText = async (prompt, options = {}) => {
  // OLD: Gemini native path (commented out)
